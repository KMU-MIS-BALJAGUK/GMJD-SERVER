package org.baljaguk.global.security.client;

import lombok.RequiredArgsConstructor;
import org.baljaguk.global.api.ErrorCode;
import org.baljaguk.global.api.handler.LoginException;
import org.baljaguk.global.security.client.dto.GoogleAccessTokenRequest;
import org.baljaguk.global.security.client.dto.GoogleAccessTokenResponse;
...
public class GoogleClient {
    ...
    private String requestGoogleAccessToken(final String code) {
        ...
        return Optional.ofNullable(response)
                .orElseThrow(() -> new LoginException(ErrorCode.NOT_FOUND_GOOGLE_ACCESS_TOKEN_RESPONSE))
                .accessToken();
    }
